
{
    ...
    class Slideshow {
        ...
        navigate(dir) {
            ...
            const currentImg = currentSlide.DOM.el.querySelectorAll('.slide__figure');
            const currentTitle = currentSlide.DOM.el.querySelector('.slide__title');
            const currentTitleLetters = Array.from(currentSlide.DOM.el.querySelectorAll('span'));
            const currentTitleLettersTotal = (currentSlide.titleLettersTotal) / 3;
            const upcomingImg = upcomingSlide.DOM.el.querySelectorAll('.slide__figure');
            const upcomingTitle = upcomingSlide.DOM.el.querySelector('.slide__title') ;
            const text = currentSlide.DOM.text;
            const upcomingText = upcomingSlide.DOM.text;
            console.log(text);
        ...
        toggleContent(action) {
            ...
            this.tl = new TimelineMax({
                onComplete: () => {
                    if ( action === 'hide' ) {
                        ...
                        this.tl
                            .set(currentSlide.DOM.text, {opacity:1}, 'begin+=3');
                    }
                    this.isAnimating = false;
                }
            }).add('begin');
            ...
            this.tl
            .set(currentSlide.DOM.text, {opacity:0}, 'begin')
        ...
        toggleSlides(currentSlide, upcomingSlide) {
            ...
            this.tl.to(upcomingSlide.DOM.text, 3, {
                opacity: 1
            }, 'begin+=3' );
